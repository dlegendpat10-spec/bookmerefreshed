...
-- -------------------------------------------------------------------
-- 9. SEED DATA (Intentionally blank; tenants register dynamically)
-- -------------------------------------------------------------------

-- -------------------------------------------------------------------
-- 10. COMMON QUERY LIBRARY
-- -------------------------------------------------------------------

-- QUERY 1: Check Dynamic Available Time Slots for a Service on a Specific Date
-- SELECT * FROM get_available_slots('00000000-0000-0000-0000-000000000001', '11111111-0000-0000-0000-000000000002', CURRENT_DATE + INTERVAL '1 day');

-- QUERY 2: Create a New Booking with Pre-calculated Starts_at & Ends_at
/*
INSERT INTO service_bookings (
  ...
  'BKM-' || UPPER(SUBSTRING(MD5(RANDOM()::TEXT) FROM 1 FOR 6)),
  ...
  '10:00',
  '11:45',
  (CURRENT_DATE + INTERVAL '1 day' + TIME '10:00') AT TIME ZONE 'Africa/Lagos',
  (CURRENT_DATE + INTERVAL '1 day' + TIME '11:45') AT TIME ZONE 'Africa/Lagos',
  'CONFIRMED', 'PAID', 25000.00, 'NGN', 'Automated reservation test'
) RETURNING *;
*/

-- QUERY 3: Dashboard Key Performance Metrics (KPIs)
/*
SELECT
  ...
  COALESCE(SUM(amount) FILTER (WHERE payment_status = 'PAID'), 0.00) AS total_revenue
