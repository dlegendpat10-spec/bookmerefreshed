-- ===================================================================
-- BOOKME — SUPABASE MIGRATION: new-migration
-- Target Supabase Project: imoihsuizdwxaryhjwjt
...
ALTER TABLE admin_profiles ALTER COLUMN business_id DROP NOT NULL;
ALTER TABLE admin_profiles ADD COLUMN IF NOT EXISTS password_hash VARCHAR(255);

-- TABLE 8: NOTIFICATION_DISPATCHES
